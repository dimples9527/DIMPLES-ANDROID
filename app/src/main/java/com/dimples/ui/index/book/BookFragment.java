...
import com.dimples.ui.index.book.adapter.BookAdapter;
import com.dimples.ui.index.book.bean.BookDataManger;
...
public class BookFragment extends BaseFragment {
    ...
    private void initRecyclerView() {
        rlContentMain.setLayoutManager(new LinearLayoutManager(mContext));
